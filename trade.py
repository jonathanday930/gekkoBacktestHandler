...
class trade:
    ...
    def set_table_name(self):
        exporter.tableName = str(self.exchange) + '_' + str(self.day_delta) + 'days'
    ...
    def importData(self):
        ...
        execString = "cd /home/jonathan/gekko/ && echo '190kilogp' | sudo -S perl backtest.pl sudo -i -f " + str(
    ...
    def run(self):
        ...
        file = '/home/jonathan/gekko/' + self.data_exporter.tableName + ".csv"
        ...
        execString = "cd /home/jonathan/gekko/ && echo '190kilogp' | sudo -S perl backtest.pl -f " + str(
            self.start_date.year) + "-" + start_month + "-" + start_day + " -t " + str(
            self.getEndDate().year) + "-" + end_month + "-" + end_day + " -n " + str(
            self.candle_Size_Min) + ":" + str(self.warmup_Size_Min) + " -p " + str(self.exchange) + ":" + str(
            self.currency) + ":" + self.asset + " -s " + self.strategy + " -o " + self.data_exporter.tableName + ".csv"
